...
(function() {
  ...
  google.maps.Load = function(apiLoad) {
    ...
    apiLoad([0.009999999776482582,[null,[["https://khms0.googleapis.com/kh?v=937\u0026hl=pt-BR\u0026","https://khms1.googleapis.com/kh?v=937\u0026hl=pt-BR\u0026"],null,null,null,1,"937",["https://khms0.google.com/kh?v=937\u0026hl=pt-BR\u0026","https://khms1.google.com/kh?v=937\u0026hl=pt-BR\u0026"]],null,null,null,null,[["https://cbks0.googleapis.com/cbk?","https://cbks1.googleapis.com/cbk?"]],[["https://khms0.googleapis.com/kh?v=150\u0026hl=pt-BR\u0026","https://khms1.googleapis.com/kh?v=150\u0026hl=pt-BR\u0026"],null,null,null,null,"150",["https://khms0.google.com/kh?v=150\u0026hl=pt-BR\u0026","https://khms1.google.com/kh?v=150\u0026hl=pt-BR\u0026"]],null,null,null,null,null,null,null,[["https://streetviewpixels-pa.googleapis.com/v1/thumbnail?hl=pt-BR\u0026","https://streetviewpixels-pa.googleapis.com/v1/thumbnail?hl=pt-BR\u0026"]]],["pt-BR","US",null,0,null,null,"https://maps.gstatic.com/mapfiles/",null,"https://maps.googleapis.com","https://maps.googleapis.com",null,"https://maps.google.com",null,"https://maps.gstatic.com/maps-api-v3/api/images/","https://www.google.com/maps",null,"https://www.google.com",1,"",0,1],["https://maps.google.com/maps-api-v3/api/js/51/3/intl/pt_br","3.51.3"],[2438495307],null,null,null,null,null,null,"",null,null,1,"https://khms.googleapis.com/mz?v=937\u0026","AIzaSyDhh53ywPlpfO814nceAem1G1eHAiRjhUM","https://earthbuilder.googleapis.com","https://earthbuilder.googleapis.com",null,"https://mts.googleapis.com/maps/vt/icon",[["https://maps.google.com/maps/vt"],["https://maps.google.com/maps/vt"],null,null,null,null,null,null,null,null,null,null,["https://www.google.com/maps/vt"],"/maps/vt",629000000,629,629364639],2,500,[null,null,null,null,"https://www.google.com/maps/preview/log204","","https://static.panoramio.com.storage.googleapis.com/photos/",["https://geo0.ggpht.com/cbk","https://geo1.ggpht.com/cbk","https://geo2.ggpht.com/cbk","https://geo3.ggpht.com/cbk"],"https://maps.googleapis.com/maps/api/js/GeoPhotoService.GetMetadata","https://maps.googleapis.com/maps/api/js/GeoPhotoService.SingleImageSearch",["https://lh3.ggpht.com/","https://lh4.ggpht.com/","https://lh5.ggpht.com/","https://lh6.ggpht.com/"],"https://streetviewpixels-pa.googleapis.com/v1/tile"],null,null,null,null,"/maps/api/js/ApplicationService.GetEntityDetails",0,null,null,null,null,[],["51.3"],1,0,[1],null,null,1,0.009999999776482582], loadScriptTime);
  };
...
zh=function(a){var b=a.ud,c=new wh;"TRUE"===a.j||"UNKNOWN"===a.j||xh(c,{Zg:"O mapa \u00e9 inicializado sem um ID de mapa v\u00e1lido, o que impede o uso de marcadores avan\u00e7ados."});b.KA=c;b=a.ud;c=new wh;if("TRUE"===a.j||"UNKNOWN"===a.j){var d=a.h;d&&(d.C().length||xh(c,{Zg:"The Map Style does not have any FeatureLayers configured for data-driven styling."}));"UNKNOWN"!==a.m&&"TRUE"!==a.m&&xh(c,{Zg:"The map is not a vector map. That will prevent use of data-driven styling."})}else xh(c,{Zg:"The map is initialized without a valid Map ID, that will prevent use of data-driven styling."});
b.Gv=c};_.Bh=function(){this.j={};this.m=0};_.Ch=function(a,b){var c=a.j,d=_.Ef(b);c[d]||(c[d]=b,++a.m,_.O(a,"insert",b),a.h&&a.h(b))};dca=function(a){return a.replace(/[+/]/g,function(b){return"+"===b?"-":"_"}).replace(/[.=]+$/,"")};gca=function(a,b){switch(b){case 0:case 1:return a;case 13:return a?1:0;case 15:return String(a);case 14:return eca(a);case 12:case 6:case 9:case 7:case 10:case 8:case 11:case 2:case 4:case 3:case 5:return fca(a,b);default:_.nc(b)}};
eca=function(a){if(_.Ha(a))return _.lc(a,4);a.constructor===_.oc&&(a=_.pc(a));return dca(a)};fca=function(a,b){switch(b){case 7:case 2:return Number(a)>>>0;case 10:case 3:if("string"===typeof a){if("-"===a[0])return _.Dd(_.zd(a))}else if(0>a)return _.Dd(_.xd(a))}return"number"===typeof a?Math.floor(a):a};_.Dh=function(){};hca=function(a){var b=0,c;for(c in a){var d=a[+c];null!=d&&(b+=4,Array.isArray(d)&&(b+=hca(d)))}return b};
jca=function(a,b,c,d){var e=_.xc(a);_.Hd(b,function(f){var g=f.Rb,h=e(g);if(null!=h)if(f.rj)for(var k=0;k<h.length;++k)d=ica(h[k],g,f,c,d);else d=ica(h,g,f,c,d)});return d};
...
Ni=function(a,b){this.h=!1;this.j="UNINITIALIZED";if(a)throw _.qg(b),Error('A configura\u00e7\u00e3o de "renderingType" do mapa n\u00e3o \u00e9 compat\u00edvel. O "renderingType" \u00e9 decidido internamente e \u00e9 somente leitura. Se quiser criar um mapa vetorial, crie um ID de mapa no Console do Cloud de acordo com o documento https://developers.google.com/maps/documentation/javascript/vector-map.');};lda=function(a){a.h=!0;try{a.set("renderingType",a.j)}finally{a.h=!1}};
